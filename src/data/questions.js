export const questionsData = {
  'life-sciences': [
    ...
    // Life Sciences - DNA, RNA, & Protein Synthesis
  {
  ...
  // Life Sciences - Evolution, Speciation & Natural Selection
  {
  ...
  {
    question: "What is a sudden change to the structure of a gene or a chromosome?",
    options: ["Mutation", "Crossing over", "Meiosis", "Transcription"],
    answer: "Mutation",
    explanation: "A mutation is an alteration in the nucleic acid sequence of the genome, introducing new alleles into a population."
  },
  {
  ...
  // Life Sciences - Human Evolution
  {
    ...
    answer: "Hypothesis",
    explanation: "A hypothesis is an initial proposed explanation made on the basis of limited evidence as a starting point for further investigation."
  },
  {
  ...
  {
    question: "What is an explanation based on a number of different hypotheses, explanations, principles, and laws called?",
    options: ["Theory", "Hypothesis", "Postulate", "Observation"],
    answer: "Theory",
    explanation: "A scientific theory (like the Theory of Evolution) is a highly reliable explanation of the natural world supported by a vast body of evidence."
  },
  {
  ...
  {
    question: "What is a sudden, random change to the structure of a gene or a chromosome called?",
    options: ["Mutation", "Recombination", "Transcription", "Translation"],
    answer: "Mutation",
    explanation: "Mutations create new alleles and are the primary source of genetic variation within any population."
  },
  {
  ...
  // Life Sciences - Plant Hormones & Tropisms
  {
  ...
  // Life Sciences - Human Reproduction & Endocrinology
  {
  ...
  // Life Sciences - Genetics, Heredity & Biotechnology
  {
  ...
  },
  {
    ...
    explanation: "An example of multiple alleles is the human ABO blood group system controlled by alleles $I^A$, $I^B$, and $i$."
  },
  {
